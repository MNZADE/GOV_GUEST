...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      /* =====================================
         OFFICER AVAILABLE AFTER RESOLVE
      ===================================== */
