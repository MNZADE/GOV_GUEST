...
export declare class Transactional extends APIResource {
     ...
     */
    send(body: TransactionalSendParams, options?: Core.RequestOptions): Core.APIPromise<TransactionalSendResponse>;
}
...
export declare namespace Transactional {
    export { type TransactionalSendResponse as TransactionalSendResponse, type TransactionalSendParams as TransactionalSendParams, };
}
