...
export declare class Verification extends APIResource {
     ...
     */
    create(body: VerificationCreateParams, options?: Core.RequestOptions): Core.APIPromise<VerificationCreateResponse>;
    /**
     * Check the validity of a verification code.
     */
    check(body: VerificationCheckParams, options?: Core.RequestOptions): Core.APIPromise<VerificationCheckResponse>;
}
export interface VerificationCreateResponse {
     ...
     *   anti-fraud system.
     */
    reason?: 'expired_signature' | 'in_block_list' | 'invalid_phone_line' | 'invalid_phone_number' | 'invalid_signature' | 'repeated_attempts' | 'suspicious';
    request_id?: string;
    /**
...
export declare namespace VerificationCreateResponse {
    /**
     * The metadata for this verification.
     */
    interface Metadata {
...
export declare namespace VerificationCheckResponse {
    /**
     * The metadata for this verification.
     */
    interface Metadata {
...
export declare namespace VerificationCheckParams {
    /**
     * The verification target. Either a phone number or an email address. To use the
     * email verification feature contact us to discuss your use case.
     */
...
export declare namespace Verification {
    export { type VerificationCreateResponse as VerificationCreateResponse, type VerificationCheckResponse as VerificationCheckResponse, type VerificationCreateParams as VerificationCreateParams, type VerificationCheckParams as VerificationCheckParams, };
}
